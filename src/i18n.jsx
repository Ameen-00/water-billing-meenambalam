...
const STR = {
  en: {
    ...
    ownerNotHome: "Owner not home — charge min (₹75)",
    readingLowMin: "Reading is below previous — minimum charge (₹75) applies.",
    alreadyBilled: "Already billed this month",
    alreadyBilledHint: "Saving again will create a second bill and add to their dues.",
    highUsage: "Unusually high reading — please double-check it before saving.",
    unpaidNote: "This consumer still has unpaid dues.",
  ...
  ml: {
    ...
    ownerNotHome: "വീട്ടുകാർ ഇല്ല — മിനിമം (₹75)",
    readingLowMin: "റീഡിംഗ് മുൻ റീഡിംഗിനെക്കാൾ കുറവ് — മിനിമം ചാർജ് (₹75).",
    alreadyBilled: "ഈ മാസം ബിൽ ചെയ്തുകഴിഞ്ഞു",
    alreadyBilledHint: "വീണ്ടും സേവ് ചെയ്താൽ രണ്ടാമത്തെ ബിൽ ഉണ്ടാകും, കുടിശ്ശിക കൂടും.",
    highUsage: "അസാധാരണമായി ഉയർന്ന റീഡിംഗ് — സേവ് ചെയ്യും മുമ്പ് ഒന്നുകൂടി പരിശോധിക്കുക.",
    unpaidNote: "ഈ ഉപഭോക്താവിന് കുടിശ്ശിക ബാക്കിയുണ്ട്.",
